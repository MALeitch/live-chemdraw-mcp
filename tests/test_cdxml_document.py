...
# legacy <graphic SupersededBy="51" GraphicType="Line"> ChemDraw writes
# alongside every real <arrow>, to confirm it's correctly excluded rather
# than picked up as a fake box.
...
<CDXML>
 <page id="1" BoundingBox="0 0 540 720">
  ...
  <scheme id="60"><step id="61" ReactionStepReactants="10 17" ReactionStepProducts="25"
   ReactionStepArrows="51" ReactionStepObjectsAboveArrow="48" ReactionStepObjectsBelowArrow="49"/></scheme>
 </page>
</CDXML>
"""
